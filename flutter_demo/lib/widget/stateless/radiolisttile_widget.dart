...
class _RadioListTileWidgetState extends State<RadioListTileWidget> {
  final Map<ItemType, ItemBean> languages = {
    ItemType.java: ItemBean("Java", "曾经世界上最流行的编程语言", "images/java.webp"),
    ItemType.kotlin: ItemBean("Kotlin", "未来世界上最流行的编程语言", "images/kotlin.webp"),
    ItemType.dart: ItemBean("Dart", "曾经世界上最优雅的编程语言", "images/dart.webp"),
  };
